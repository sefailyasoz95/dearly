...
export default function UploadPage() {
	...
	const onDrop = useCallback((acceptedFiles: File[]) => {
		...
		const mediaFiles = acceptedFiles.filter((file) => file.type.startsWith("image/") || file.type.startsWith("video/"));
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormDescription>Describe these memories to help you find them later.</FormDescription>
												<FormMessage />
											</FormItem>
										)}
									/>
